...
var SHR4P_init=function(){SHR4P.debug("SHR4P_init called");if(SHR4P.init)SHR4P.debug("SHR4P_init returning because already loaded");else{SHR4P.init=true;SHR4P.jQuery=typeof sb_dont_noConflict!="undefined"&&sb_dont_noConflict?jQuery:jQuery.noConflict(true);(function(b){SHR4P.debug("initializing shareaholic_publishers plugin");b.fn.shareaholic_publishers=function(c){var a=b.extend({v:1,src:"http://www.shareaholic.com",mode:"inject",service:"",apikey:"",link:"",title:"",notes:"",expand:true,duration:400,
rel:"nofollow",target:"_blank",twitter_template:"${title} - ${short_link} via @Shareaholic",dontShowShareCount:false,fbLikeButton:false,fbButtonPos:"bottom-right",tags:"",allowExternalTags:true,designer_toolTips:false,tip_bg_color:"black",tip_text_color:"white",category:"",ctype:"",short_link:"",shortener:"google",shortener_key:"",custom_link:{},bgimg:"",bgimg_padding:"0 0 0 0",center:false,spaced:false,iframe_src:"/publishers",spriteimg:"",share_src:"http://www.shareaholic.com",localize:false,li_margin:0,
"margin-top":20,"margin-bottom":20,"margin-left":0,"bgimg-padding-top":0,"bgimg-padding-left":0,"icon-width":60,"icon-height":29,"icon-margin-top":3,"promo-height":c.shrlink?18:0,shrlink:false,twitter_overlay:true},c);SHR4P.debug("$.fn.shareaholic_publishers called");SHR4P.debug(a);if(b.browser.msie&&b.browser.version<"7.0")a["icon-height"]+=4;if(!a.link)a.link=document.location.href;if(a.bgimg!=null){c=b.trim(a.bgimg_padding).split(" ");a["bgimg-padding-top"]=c[0]?Number(c[0].replace(/[a-zA-Z]+/,
"")):0;a["bgimg-padding-left"]=c[3]?Number(c[3].replace(/[a-zA-Z]+/,"")):0;a["margin-left"]=10}if(a.localize)a.iframe_src="/publishers.html";var h=function(){var d=0;if(!b.isEmptyObject(a.custom_link))d=b(a.custom_link).length;return a.service.split(",").length+d},p=function(){return a["margin-left"]+a["bgimg-padding-left"]},n=function(d){return Math.ceil(h()/Math.floor((d-p())/a["icon-width"]))},k=function(d){return a.expand?a["margin-top"]+a["bgimg-padding-top"]+a["icon-height"]+a["icon-margin-top"]+
(n(d)==1?a["promo-height"]:0):l(d)},l=function(d){return a["margin-top"]+a["bgimg-padding-top"]+(a["icon-height"]+a["icon-margin-top"])*n(d)+a["promo-height"]},m=function(d){SHR4P.debug("centering");var f=0;if(n(d)==1){SHR4P.debug("one row! do centering");f=(d-p()-h()*a["icon-width"])/2;SHR4P.debug("returning "+f+" margin")}return f},r=function(d){SHR4P.debug("spacing");SHR4P.debug("rows: "+n(d));var f=0;if(n(d)==1){SHR4P.debug("one row! spacing icons");f=Math.floor((d-p()-a["icon-width"]*h())/h());
SHR4P.debug("returning "+f+" margin")}return f};this.each(function(){if(a.spaced)a.li_margin=r(b(this).width());var d={src:a.src,service:a.service,apikey:a.apikey,link:a.link,title:a.title,notes:a.notes,bgimg:a.bgimg,bgimg_padding:a.bgimg_padding,rel:a.rel,target:a.target,twitter_template:a.twitter_template,localize:a.localize,share_src:a.share_src,spriteimg:a.spriteimg,tags:a.tags,allowExternalTags:a.allowExternalTags,designer_toolTips:a.designer_toolTips,tip_bg_color:a.tip_bg_color,tip_text_color:a.tip_text_color,
category:a.category,ctype:a.ctype,custom_link:a.custom_link,li_margin:a.li_margin,short_link:a.short_link,shortener:a.shortener,shortener_key:a.shortener_key,shrlink:a.shrlink,expand:a.expand,dontShowShareCount:a.dontShowShareCount,fbLikeButton:a.fbLikeButton,fbButtonPos:a.fbButtonPos,twitter_overlay:a.twitter_overlay};a.center&&b(this).css({"margin-left":m(b(this).width())});a.mode=="inject"?b(this).shareaholic(d):b(this).append(b('<iframe frameborder="0"/>').attr({src:[a.src+a.iframe_src,b.param(d)].join("?"),
height:k(b(this).width()),width:b(this).width(),scrolling:"no","class":"share-iframe"}).css({height:l(b(this).width())}));if(a.expand){b(this).css({overflow:"hidden",height:k(b(this).width())});b(this).hover(function(){b(this).animate({height:l(b(this).width())},{duration:a.duration,queue:false})},function(){b(this).animate({height:k(b(this).width())},{duration:a.duration,queue:false})})}});return this};var e=function(c,a){var h=function(){SHR4P.debug("bitly javascript loaded");var l=c.link;BitlyCB.mycallback=
function(m){SHR4P.debug("bit.ly calls back with");SHR4P.debug(m);if(m.errorCode==0){SHR4P.debug("successfully shortened, calling callback with: ");m=m.results[l].shortUrl;SHR4P.debug("short_link: "+m);SHR4P.debug("type: "+typeof m);a(m)}};BitlyClient.call("shorten",{longUrl:l},"BitlyCB.mycallback")};if(typeof BitlyClient=="undefined"){SHR4P.debug("loading bit.ly");var p=document.getElementsByTagName("head")[0];if(typeof p!="undefined"){var n=c.shortener_key.split("|"),k=document.createElement("script");
k.src="http://bit.ly/javascript-api.js?version=latest&login="+n[0]+"&apiKey="+n[1];k.type="text/javascript";k.charset="utf-8";p.appendChild(k);k.onreadystatechange=function(){if(this.readyState=="complete"||this.readyState=="loaded"){SHR4P.debug("bit.ly loaded with onreadystatechange, init'ing");h()}};k.onload=h}}else{SHR4P.debug("bit.ly already loaded.  init'ing");h()}};SHR4P.debug("initializing shareaholic plugin");b.fn.shareaholic=function(c){var a=b.extend({service:"",rel:"nofollow",target:"_blank",
...
SHR4P.debug(a);b(this).addClass("shareaholic-show-on-load");if(a.localize==true||a.localize=="true")a.localize=true;var h=function(d,f){return[d,b.param(f)].join("?")},p=function(d){for(var f=[],j=d.length,i=0;i<j;i++){for(var g=i+1;g<j;g++)if(d[i]===d[g])g=++i;f.push(d[i])}return f},n=function(d,f,j){var i=j.designer_toolTips?"orig_title":"title",g=j.custom_link[d+"_"+f];SHR4P.debug("adding link "+d+" "+f);return b("<li/>").addClass(g.li_class).append(b("<a/>").attr({href:g.link,rel:j.rel,target:j.target,
"class":"external"}).attr(i,g.tooltip)).attr("style",g.style+";margin-left:"+j.li_margin+"px !important;")};c=a.localize?a.src+"/sprite.css":h(a.src+a.api.sprite.url,{v:a.api.sprite.v,apikey:a.apikey,service:p(a.service.split(",")).sort().join(",")});b("#shareaholic-publisher-css").length==0&&b("head").append(b('<link rel="stylesheet" media="screen" id="shareaholic-publisher-css" href="'+c+'"/>'));var k=b("<div/>").addClass("shr-bookmarks").append(b("<ul/>").addClass("shr-socials"));if(a.shrlink){c=
b.getBrowser();if(c!=""){k.append(b('<div style="clear: both;"></div><div class="shr-getshr" style="visibility:hidden;font-size:10px !important"><a target="_blank" href="http://www.shareaholic.com/?src=pub">Get Shareaholic</a></div><div style="clear: both;"></div>'));k.find(".shr-getshr a").text("Get Shareaholic for "+c);b(this).hover(function(){k.find(".shr-getshr").css("visibility","visible")},function(){k.find(".shr-getshr").css("visibility","hidden")})}}a.bgimg!="undefined"&&a.bgimg!=""&&k.addClass("shr-bookmarks-bg-shr").css({"margin-left":"10px",
height:"100%","overflow-x":"hidden","overflow-y":"hidden",display:"block",padding:a.bgimg_padding,background:"transparent url("+a.bgimg+") no-repeat"});var l=k.find(".shr-socials");if(a.fbLikeButton){setTimeout("SHR4P.fbUtil.addFBConnect()",0);c=b('<div class="shareaholic-like-buttons"><br/></div>');var m=b('<a class="shareaholic-fb-like" style="margin-top:5px; margin-bottom:5px;"></a>');SHR4P.fbUtil.addLikeButton(m,a.link);c.prepend(m);a.fbButtonPos.indexOf("bottom")!=-1?c.insertAfter(this):c.insertBefore(this);
a.fbButtonPos.indexOf("right")!=-1&&m.css("float","right")}b(a.service.split(",")).each(function(d,f){var j="";if(f=="7")j=a.twitter_template;a.custom_link["before_"+d]&&n("before",d,a).appendTo(l);var i=a.designer_toolTips?"orig_title":"title",g=SHR4P.utils.getBrowserLocale();g=g.split("-")[0];if(typeof SHR4P.locales[g]=="undefined"||!SHR4P.locales[g])g="en";g=SHR4P.locales[g][SHR4P.tooltips_prefix_map[f]]+" "+SHR4P.tooltips_suffix[f];f=="7"&&a.twitter_overlay&&!SHR4P.utils.isMobileBrowser()?b("<li/>").addClass("shr-"+
f).addClass("shareaholic").append(b("<a/>").attr({rel:a.rel,target:a.target,"class":"external"}).attr(i,g).click(function(o){SHR4P.utils.showServiceLet(a,"twitter");o.preventDefault()})).attr("style","margin-left:"+a.li_margin+"px !important;").appendTo(l):b("<li/>").addClass("shr-"+f).addClass("shareaholic").append(b("<a/>").attr({href:h(a.share_src+a.api.share.url,{title:a.title,link:a.link,notes:a.notes,short_link:a.short_link,shortener:a.shortener,shortener_key:a.shortener_key,v:a.api.share.v,
apitype:a.api.share.apitype,apikey:a.apikey,source:a.api.share.source,template:j,service:f,ctype:a.ctype}),rel:a.rel,target:a.target,"class":"external"}).attr(i,g)).attr("style","margin-left:"+a.li_margin+"px !important;").appendTo(l);if(!a.dontShowShareCount&&(f==5||f==7||f==2||f==257)){j=function(o){o=o.count;if(o>0){for(var s=b("<div/>").addClass("shr-count").appendTo(l.find(".shr-"+f)),q=0;q<9;q+=1)q!=4&&s.append(b("<div>"+o+"</div>").addClass("shr-count-outline").css({left:10+q%3-1+"px",top:"-"+
(11+parseInt(q/3)-1)+"px"}));s.append(b("<div>"+o+"</div>").addClass("shr-count-center").css({left:"10px",top:"-11px"}))}};if(f==5)SHR4P.utils.getFbShrCnt(a.link,j);else if(f==7)SHR4P.utils.getTwitShrCnt(a.link,j);else if(f==2)SHR4P.utils.getDeliciousShrCnt(a.link,j);else f==257&&SHR4P.utils.getGoogBuzzShrCnt(a.link,j)}a.custom_link["after_"+d]&&n("after",d,a).appendTo(l)});var r=function(){var d=b("<div style='position:absolute !important; background: transparent !important; z-index:101 !important;'/>"),
f=b("<div class = 'shareaholic-tip-text'></div>"),j=b("<div class = 'shareaholic-arrow-down'/>");d.append(f);d.append(j);return{show:function(i){if(!b("body").find(".shareaholic-tip-text").length){var g=b(i).find("a").attr("orig_title");f.text(g);g=b(i).offset();d.appendTo(document.body);var o=d.width();i=b(i).width();d.css({left:g.left-o/2+i/2,top:g.top-32});d.css({opacity:0.9})}},hide:function(){d.remove()}}}();if(a.designer_toolTips){b("<style type='text/css'>.shareaholic-arrow-down{ position: absolute !important; left:45% !important; width: 0 !important; height: 0 !important; border-left: 6px solid transparent !important; border-right: 6px solid transparent !important; border-top: 6px solid "+
a.tip_bg_color+" !important; }.shareaholic-tip-text{font-size:12px !important; line-height:120% !important; background: "+a.tip_bg_color+" !important; color: "+a.tip_text_color+" !important; padding: 5px !important; border-radius: 5px !important; -webkit-border-radius:5px; !important; -moz-border-radius:5px; !important}</style>").appendTo("head");l.find("li").mouseenter(function(d){r.show(d.currentTarget)}).mouseleave(function(d){r.hide(d.currentTarget)})}c=function(d){b(l).find("li a").each(function(){this.href=
this.href+"&tags="+d})};a.allowExternalTags?SHR4P.utils.getTags(a.link,a.tags,c):c(a.tags);c=function(d){if(d.spriteimg!="")return d.spriteimg;else if(d.localize)return d.src+"/sprite.png";else{var f=function(g,o){return g-o},j=p(d.service.split(",")).sort(f);SHR4P.debug("checking services: ");SHR4P.debug(j);var i=[];b(SHR4P.img_group).each(function(){var g=this;SHR4P.debug("checking img_group: ");SHR4P.debug(g);b(j).each(function(){SHR4P.debug("checking service: "+this);if(b.inArray(Number(this),
g)>-1){SHR4P.debug("found! adding img_group");b.merge(i,g);return false}});SHR4P.debug("req_services so far: ");SHR4P.debug(i)});SHR4P.debug("final req_services: ");i=i.sort(f);SHR4P.debug(i.join(","));return h(d.src+d.api.sprite.url,{v:d.api.sprite.v,apikey:d.apikey,apitype:"png",service:i.join(",")})}}(a);k.append(b('<style type="text/css">ul.shr-socials li.shareaholic{background-image:url('+c+") !important;}</style>"));k.appendTo(this);return this};b.extend({getBrowser:function(){var c=navigator.userAgent,
...
SHR4P.utils={getGoogBuzzShrCnt:function(b,e){b="http://www.google.com/buzz/api/buzzThis/buzzCounter?url="+encodeURIComponent(b);SHR4P.jQuery.getJSON(b+"&callback=?",function(c){var a=0;if(typeof c!="undefined"&&c)for(var h in c){a=c[h];break}e({count:a})})},getFbShrCnt:function(b,e){b="http://api.ak.facebook.com/restserver.php?v=1.0&method=links.getStats&format=json&urls="+encodeURIComponent(b);SHR4P.jQuery.getJSON(b+"&callback=?",function(c){var a=0;if(c.length>0){a=c[0].total_count;if(a!=0)if(a>
...
"K"}e({count:a})})},getTags:function(b,e,c){var a=1;SHR4P.utils.getDeliciousTag(b,function(h){e+=h;--a==0&&c(e)})},getDeliciousTag:function(b,e){b="http://feeds.delicious.com/v2/json/urlinfo/data?url="+encodeURIComponent(b);SHR4P.jQuery.getJSON(b+"&callback=?",function(c){if(c.length>0){top_tags=c[0].top_tags;del_tags="";SHR4P.jQuery.each(top_tags,function(a,h){del_tags+=encodeURIComponent(a)+"|"+h+"|delicious,"});if(del_tags!="")del_tags=del_tags.substr(0,del_tags.length-1);e(del_tags)}})},showServiceLet:function(b,
...
4))},getBrowserLocale:function(){var b="en-us";if(navigator)if(navigator.language)b=navigator.language;else if(navigator.browserLanguage)b=navigator.browserLanguage;else if(navigator.systemLanguage)b=navigator.systemLanguage;else if(navigator.userLanguage)b=navigator.userLanguage;return b.toLowerCase()}};
...
SHR4P.googPlusOneUtil={addGoogScript:function(){if(SHR4P.jQuery("#googplusonescript").length==0){var b=document.createElement("script");b.async=true;b.src="https://apis.google.com/js/plusone.js";b.id="googplusonescript";b.innerHTML='{"parsetags": "explicit"}';document.getElementsByTagName("head")[0].appendChild(b);b.onreadystatechange=function(){if(this.readyState=="complete"||this.readyState=="loaded")SHR4P.googPlusOneUtil.renderPlusOnes()};b.onload=SHR4P.googPlusOneUtil.renderPlusOnes}},renderPlusOnes:function(){SHR4P.jQuery(".shareaholic-googleplusone",
".shareaholic-like-buttonset").each(function(){var b=SHR4P.jQuery(this),e=b.attr("shr_href");if(typeof e=="undefined"||!e)e=encodeURIComponent(document.location.href);var c=b.attr("shr_count");if(typeof c=="undefined"||!c)c="true";var a=b.attr("shr_size");if(typeof a=="undefined"||!a)a="standard";var h=SHR4P.jQuery("<div style='float:left; margin:0px 0px 0px 10px !important;'/>").get(0);b.replaceWith(h);SHR4P.jQuery(h).append("<div/>");h=SHR4P.jQuery(h).find(":first-child").get(0);gapi.plusone.render(h,
{size:a,count:c,href:e,callback:"SHR4P_trackPlusOneClick"})})},trackPlusOneClick:function(b){b.state=="on"&&SHR4P.jQuery("<img/>").attr({src:"http://www.shareaholic.com/api/share/?v=1&apikey=172809fde4d12743cc4a1ec894142b97f&apitype=3&service=304&link="+encodeURIComponent(b.href),width:"1",height:"1"}).appendTo("body")}};var SHR4P_trackPlusOneClick=function(b){SHR4P.googPlusOneUtil.trackPlusOneClick(b)};
SHR4P.fbUtil={fbConnectAdd:0,hasFB:function(){return typeof window.FB=="object"&&FB.Event&&typeof FB.Event.subscribe=="function"},addLikeButton:function(b,e){var c=SHR4P.jQuery('<fb:like href="'+e+'"layout="button_count" show_faces="true" width="60" font=""></fb:like>').appendTo(b);typeof window.FB!="undefined"&&FB.XFBML&&FB.XFBML.parse&&FB.XFBML.parse(c.get(0))},renderFBWidgets:function(){setTimeout("SHR4P.fbUtil.renderFBLikeButtons()",0);setTimeout("SHR4P.fbUtil.renderFBSendButtons()",0)},renderFBSendButtons:function(){SHR4P.jQuery(".shareaholic-fbsend",
".shareaholic-like-buttonset").each(function(){var b=SHR4P.jQuery(this),e=b.attr("shr_href");if(typeof e=="undefined"||!e)e=encodeURIComponent(document.location.href);var c=SHR4P.jQuery("<div style='float:left;padding-top:2px !important; margin:0px 5px !important;'/>").get(0);b.replaceWith(c);b=SHR4P.jQuery('<fb:send href="'+e+'" width="60" font=""></fb:send>').appendTo(c);typeof window.FB!="undefined"&&FB.XFBML&&FB.XFBML.parse&&FB.XFBML.parse(b.get(0))})},renderFBLikeButtons:function(){SHR4P.jQuery(".shareaholic-fblike",
".shareaholic-like-buttonset").each(function(){var b=SHR4P.jQuery(this),e=b.attr("shr_href");if(typeof e=="undefined"||!e)e=encodeURIComponent(document.location.href);var c=b.attr("shr_layout");if(typeof c=="undefined"||!c)c="button_count";var a=b.attr("shr_showfaces");if(typeof a=="undefined"||!a)a="true";var h=SHR4P.jQuery("<div style='float:left;padding-top:2px !important; margin:0px 5px !important;'/>").get(0);b.replaceWith(h);b=SHR4P.jQuery('<fb:like href="'+e+'"layout="'+c+'" show_faces="'+
a+'" width="60" font=""></fb:like>').appendTo(h);typeof window.FB!="undefined"&&FB.XFBML&&FB.XFBML.parse&&FB.XFBML.parse(b.get(0))})},addFBConnect:function(){SHR4P.fbUtil.addFBNameSpace();if(!SHR4P.fbUtil.hasFB()&&!SHR4P.fbUtil.fbConnectAdd){SHR4P.jQuery('<div id="fb-root"></div>').appendTo("body");window.fbAsyncInit=function(){FB.init({appId:"337255590733",status:true,cookie:true,xfbml:true});SHR4P.fbUtil.tryAddFBSubscription()};(function(){var b=document.createElement("script");b.async=true;b.src=
document.location.protocol+"//connect.facebook.net/en_US/all.js";b.onreadystatechange=function(){if(this.readyState=="complete"||this.readyState=="loaded")SHR4P.fbUtil.renderFBWidgets()};b.onload=SHR4P.fbUtil.renderFBWidgets;document.getElementById("fb-root").appendChild(b)})();SHR4P.fbUtil.fbConnectAdd=1}else if(!SHR4P.fbUtil.fbConnectAdd){SHR4P.fbUtil.tryAddFBSubscription();SHR4P.fbUtil.fbConnectAdd=1}},tryAddFBSubscription:function(){SHR4P.fbUtil.hasFB()&&FB.XFBML&&FB.XFBML.parse?SHR4P.fbUtil.addFBSubscription():
setTimeout(SHR4P.fbUtil.tryAddFBSubscription,500)},addFBSubscription:function(){FB.Event.subscribe("edge.create",function(b){SHR4P.jQuery("<img/>").attr({src:"http://www.shareaholic.com/api/share/?v=1&apikey=172809fde4d12743cc4a1ec894142b97f&apitype=3&service=303&link="+encodeURIComponent(b),width:"1",height:"1"}).appendTo("body")});FB.Event.subscribe("message.send",function(b){SHR4P.jQuery("<img/>").attr({src:"http://www.shareaholic.com/api/share/?v=1&apikey=172809fde4d12743cc4a1ec894142b97f&apitype=3&service=305&link="+
encodeURIComponent(b),width:"1",height:"1"}).appendTo("body")})},addFBNameSpace:function(){var b=SHR4P.jQuery(SHR4P.jQuery("html").get(0));typeof b.attr("xmlns:fb")=="undefined"&&b.attr("xmlns:fb","http://developers.facebook.com/schema/")}};
